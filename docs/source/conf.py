...
project = f"Xena Python RFC Converter"
copyright = f"{year}, {company}"
author = company
title = f"Xena Python RFC Converter Documentation"
output_basename = f"xena_rfc_converter"

# The full version, including alpha/beta/rc tags.
release = get_version("../../xena_rfc_converter/__init__.py")

# The short X.Y version.
version = get_short_version("../../xena_rfc_converter/__init__.py")
